(()=>{
  ...
  function acceptanceLimits(){const level=Number(state.level?.level||1);if(level<=6)return{maxDistance:4.35,strongDistance:3.15,maxRank:5};if(level<=16)return{maxDistance:4.05,strongDistance:2.95,maxRank:4};return{maxDistance:3.7,strongDistance:2.7,maxRank:3};}
