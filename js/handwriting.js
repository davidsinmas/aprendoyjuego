(()=>{
  ...
  function acceptanceLimits(){const level=Number(state.level?.level||1);if(level<=6)return{maxDistance:3.85,strongDistance:2.75,ambiguity:.55,maxRank:3};if(level<=16)return{maxDistance:3.55,strongDistance:2.5,ambiguity:.42,maxRank:2};return{maxDistance:3.25,strongDistance:2.3,ambiguity:.3,maxRank:2};}
